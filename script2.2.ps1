...
$path_dir1 = Get-Item "C:\Users\pourl\Documents\stage\Stage\test1"
$path_dir2 = Get-Item "C:\Users\pourl\Documents\stage\Stage\test2"

#chemin des dossiers d'archive (dans le dossier destination)
$path_archive_dir1 = Get-Item "C:\Users\pourl\Documents\stage\Stage\test1\Archive"
$path_archive_dir2 = Get-Item "C:\Users\pourl\Documents\stage\Stage\test2\Archive"

#contenu des dossiers destination (fichiers uniquement, pas d'archivage de dossiers)
$dir1 = Get-ChildItem "C:\Users\pourl\Documents\stage\Stage\test1" -File
$dir2 = Get-ChildItem "C:\Users\pourl\Documents\stage\Stage\test2" -File

#chemin des fichiers à archiver (ajouter une ligne pour chaque fichier, sous le format indiqué en commentaire si-dessous
#$ficx = Get-Item ":\nomdufichier"
$fic1 = Get-Item "C:\Users\pourl\Documents\stage\Stage\Documentation Keepass.docx"
$fic2 = Get-Item "C:\Users\pourl\Documents\stage\Stage\Documentation Keepass.pdf"
$fic3 = Get-Item "C:\Users\pourl\Documents\stage\Stage\guide_achats_informatiques_juin_2019.pdf"
$fic4 = Get-Item "C:\Users\pourl\Documents\stage\Stage\Mémo_recherche_messages.pdf"
